...
event_ch_html = list(filter(lambda x: x.endswith(".html"), os.listdir("../html/event_ch/")))
...
for te_html in event_ch_html[3000:]:# te_html  = event_ch_html[4150]
    ...
    #####
    # Read file
    file = open("../html/event_ch/{}".format(te_html), "r") 
    string = file.read()
        ...
        for m in matchs:#m=matchs[0]
            ...
            if db_active:
                 ...
                 if not in_db and db_active:     
                    ...
                    if looser_player_1 !='0000' and not looser_player_1 is None: c.execute("""insert into partake (player_id, match_id, won) values (%s,%s,%s)""" , (looser_player_1, match_id, False))
                    ...
                    if looser_player_2 !='0000' and not looser_player_2 is None: c.execute("""insert into partake (player_id, match_id, won) values (%s,%s,%s)""" , (looser_player_2, match_id, False))                    
                    sets=len(scores)
